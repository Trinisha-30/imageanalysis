...
genai.configure(api_key=os.getenv("AIzaSyCN_M5-5J737puZIADgxMDCcgGnZMlQGbM"))  # Replace with your API key
...
iface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(
            ["Hindi", "Tamil", "Telugu", "Malayalam", "Kannada", "Marathi", "Bengali","Punjabi","Engilsh","Spanish","French","Japanese","German","Russian"], 
